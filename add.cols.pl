...
## pathway = http://www.kegg.jp/kegg-bin/search_pathway_text?map=hsa&keyword=${148398}&mode=1&viewImage=true
...
while(my $l = <FH>) {
    ...
    if ($a[$gene_id] ne '-' )   {
        ...
        $pathway = "=Hyperlink(\"http://www.kegg.jp/kegg-bin/search_pathway_text?map=hsa&keyword=${gid}&mode=1&viewImage=true\",\"link\")";
