...
then	
	...
	then
		...
		do            
			...
			then
				...
				then
					...
					qsub_args="-N $type.$version.align_novo.$sample.$run_num -pe threaded $threads -t 1-$numfiles:1 -l h_vmem=$mem"
				...
				then
					...
					qsub_args="-N $type.$version.align_read_bwa.R1.$sample.$run_num -pe threaded $threads -t 1-$numfiles:1 -l h_vmem=$mem"
					qsub $args $qsub_args $script_path/align_read_bwa.sh $sample $output_dir 1 $run_info
					if [ $paired == 1 ]
					then
						$script_path/check_qstat.sh $limit
						mem=$( cat $memory_info | grep -w '^align_read_bwa' | cut -d '=' -f2)
						qsub_args="-N $type.$version.align_read_bwa.R2.$sample.$run_num -pe threaded $threads -t 1-$numfiles:1 -l h_vmem=$mem"
					...
					qsub_args="-N $type.$version.align_bwa.$sample.$run_num -t 1-$numfiles:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.processBAM.$sample.$run_num $hold -l h_vmem=$mem"
				...
				then
					...
					qsub_args="-N $type.$version.extract_reads_bam.$sample.$run_num -hold_jid $type.$version.processBAM.$sample.$run_num -l h_vmem=$mem"
			...
			then
				...
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^processBAM' | cut -d '=' -f2)
				qsub_args="-N $type.$version.processBAM.$sample.$run_num -l h_vmem=$mem"
				qsub $args $qsub_args $script_path/processBAM.sh $align_dir $sample $run_info
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^extract_reads_bam' | cut -d '=' -f2)
				qsub_args="-N $type.$version.extract_reads_bam.$sample.$run_num -hold_jid $type.$version.processBAM.$sample.$run_num -l h_vmem=$mem"
			...
			then
				...
				then
					...
					qsub_args="-N $type.$version.reformat_BAM.$sample.$run_num -l h_vmem=$mem"
					qsub $args $qsub_args $script_path/reformat_BAM.sh $realign_dir $sample $run_info	
					$script_path/check_qstat.sh $limit
					mem=$( cat $memory_info | grep -w '^extract_reads_bam' | cut -d '=' -f2)
					qsub_args="-N $type.$version.extract_reads_bam.$sample.$run_num -hold_jid $type.$version.reformat_BAM.$sample.$run_num -l h_vmem=$mem"
					...
					qsub_args="-N $type.$version.split_bam_chr.$sample.$run_num -hold_jid $type.$version.reformat_BAM.$sample.$run_num -t 1-$numchrs:1 -l h_vmem=$mem"
					...
					qsub_args="-N $type.$version.realign_recal.$sample.$run_num -hold_jid $type.$version.processBAM.$sample.$run_num -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.igv_bam.$sample.$run_num -hold_jid $variant_id,$type.$version.extract_reads_bam.$sample.$run_num -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.variants.$sample.$run_num -hold_jid $variant_id -pe threaded $threads -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.merge_variant_single.$sample.$run_num -pe threaded $threads -hold_jid $type.$version.variants.$sample.$run_num -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.OnTarget_BAM.$sample.$run_num -hold_jid $variant_id -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.OnTarget_PILEUP.$sample.$run_num -hold_jid $variant_id -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.getCoverage.$sample.$run_num -hold_jid $type.$version.OnTarget_PILEUP.$sample.$run_num -l h_vmem=$mem"
			...
			then
				...
				then
					...
					qsub_args="-N $type.$version.reformat_VARIANTs_OnTarget.$sample.$run_num -l h_vmem=$mem"
			...
			then
				...
				qsub_args="-N $type.$version.OnTarget_variant.$sample.$run_num -t 1-$numchrs:1 $hold_args -l h_vmem=$mem"
			...
			then
				...
				then
					...
					qsub_args="-N $type.$version.reformat_VARIANTs.$sample.$run_num -l h_vmem=$mem"
			...
			then
				...
				then
					...
					qsub_args="-N $type.$version.sift.$sample.$run_num $hold_args -t 1-$numchrs:1 -l h_vmem=$mem"
					...
					qsub_args="-N $type.$version.polyphen.$sample.$run_num $hold_args -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.snpeff.$sample.$run_num $hold_args -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.reports.$sample.$run_num $hold -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.sample_report.$sample.$run_num -hold_jid $type.$version.reports.$sample.$run_num -l h_vmem=$mem"
				...
				then
					...
					qsub_args="-N $type.$version.run_breakdancer.$sample.$run_num -hold_jid $variant_id -t 1-$numchrs:1 -l h_vmem=$mem"
					...
					qsub_args="-N $type.$version.summaryze_struct_single.$sample.$run_num -l h_vmem=$mem $hold"
				...
				then
					...
					qsub_args="-N $type.$version.annotation_CNV.$sample.$run_num -hold_jid $type.$version.plot_circos_cnv_sv.$sample.$run_num -l h_vmem=$mem"
					...
					qsub_args="-N $type.$version.annotation_SV.sh.$sample.$run_num -hold_jid $type.$version.plot_circos_cnv_sv.$sample.$run_num -l h_vmem=$mem"
			...
			qsub_args="-N $type.$version.sample_numbers.$sample.$run_num $hold_args -l h_vmem=$mem"
			...
			then
				...
				qsub_args="-N $type.$version.gene_summary.$sample.$run_num $hold_args -l h_vmem=$mem"
		...
		then
			...
			qsub_args="-N $type.$version.merge_raw_variants.$run_num -t 1-$numchrs:1 -hold_jid $id -l h_vmem=$mem"
			...
			qsub_args="-N $type.$version.concat_raw_variants.$run_num -hold_jid $type.$version.merge_raw_variants.$run_num -l h_vmem=$mem"
		...
		then
			...
			qsub_args="-N $type.$version.merge_sample.$run_num -hold_jid $id -l h_vmem=$mem"
		...
		qsub_args="-N $type.$version.generate_html.$run_num $hold -l h_vmem=$mem"
		...
		do
			...
			then
				...
				then
					...
					$script_path/check_qstat.sh $limit
					mem=$( cat $memory_info | grep -w '^align_bwa' | cut -d '=' -f2)
					qsub_args="-N $type.$version.align_bwa.$sample.$run_num $hold -t 1-$numfiles:1 -l h_vmem=$mem"
					qsub $args $qsub_args $script_path/align_bwa.sh $sample $output_dir $run_info
					hold="$type.$version.align_bwa.$sample.$run_num"
				fi	    
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^processBAM' | cut -d '=' -f2)
				qsub_args="-N $type.$version.processBAM.$sample.$run_num -hold_jid $hold -l h_vmem=$mem"
				qsub $args $qsub_args $script_path/processBAM.sh $align_dir $sample $run_info 
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^extract_reads_bam' | cut -d '=' -f2)
				qsub_args="-N $type.$version.extract_reads_bam.$sample.$run_num -hold_jid $type.$version.processBAM.$sample.$run_num -l h_vmem=$mem"
		...
		then
			...
			do
				...
				then
					...
					qsub_args="-N $type.$version.reformat_pairBAM.$group.$run_num -l h_vmem=$mem"
					qsub $args $qsub_args $script_path/reformat_pairBAM.sh $realign_dir $group $run_info
					$script_path/check_qstat.sh $limit
					mem=$( cat $memory_info | grep -w '^extract_reads_bam' | cut -d '=' -f2)
					qsub_args="-N $type.$version.extract_reads_bam.$group.$run_num -hold_jid $type.$version.reformat_pairBAM.$group.$run_num -l h_vmem=$mem"
					...
					for sample in $samples
					do
						vvid=$vvid"$type.$version.processBAM.$sample.$run_num,$type.$version.extract_reads_bam.$sample.$run_num"
					done    
					$script_path/check_qstat.sh $limit
					mem=$( cat $memory_info | grep -w '^realign_recal' | cut -d '=' -f2)
					qsub_args="-N $type.$version.realign_recal.$group.$run_num -hold_jid $vvid -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.split_sample_pair.$group.$run_num -hold_jid $variant_id -t 1-$numchrs:1 -l h_vmem=$mem"
				qsub $args $qsub_args $script_path/split_sample_pair.sh $output_realign $igv $group $output_align $run_info
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^igv_bam' | cut -d '=' -f2)
				qsub_args="-N $type.$version.igv_bam.$group.$run_num -hold_jid $type.$version.split_sample_pair.$group.$run_num -l h_vmem=$mem"
				qsub $args $qsub_args $script_path/igv_bam.sh $output_realign $igv $group $output_align $run_info 
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^variants' | cut -d '=' -f2)
				qsub_args="-N $type.$version.variants.$group.$run_num -hold_jid $variant_id -pe threaded $threads -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				qsub_args="-N $type.$version.merge_variant_group.$group.$run_num -pe threaded $threads -hold_jid $type.$version.variants.$group.$run_num -l h_vmem=$mem"
				...
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^getCoverage' | cut -d '=' -f2)
				qsub_args="-N $type.$version.getCoverage.$group.$run_num -hold_jid $type.$version.OnTarget_PILEUP.$group.$run_num -l h_vmem=$mem"
				qsub $args $qsub_args $script_path/getCoverage.sh $output_OnTarget $numbers $group $run_info
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^OnTarget_variant' | cut -d '=' -f2)
				qsub_args="-N $type.$version.OnTarget_variant.$group.$run_num -hold_jid $type.$version.merge_variant_group.$group.$run_num -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^sift' | cut -d '=' -f2)
				qsub_args="-N $type.$version.sift.$group.$run_num $hold_args -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^snpeff' | cut -d '=' -f2)
				qsub_args="-N $type.$version.snpeff.$group.$run_num $hold_args -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^polyphen' | cut -d '=' -f2)
				qsub_args="-N $type.$version.polyphen.$group.$run_num $hold_args -t 1-$numchrs:1 -l h_vmem=$mem"
				...
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^sample_report' | cut -d '=' -f2)
				qsub_args="-N $type.$version.sample_reports.$sample.$run_num -hold_jid $type.$version.reports.$group.$run_num -l h_vmem=$mem"
				...
				then
					...
					do
						$script_path/check_qstat.sh $limit
						mem=$( cat $memory_info | grep -w '^run_breakdancer' | cut -d '=' -f2)
						qsub_args="-N $type.$version.run_breakdancer.$group.$sam.$run_num -hold_jid $type.$version.split_sample_pair.$group.$run_num -t 1-$numchrs:1 -l h_vmem=$mem"
						qsub $args $qsub_args $script_path/run_breakdancer.sh $sam $igv $break/$group $run_info $group
						$script_path/check_qstat.sh $limit
						qsub_args="-N $type.$version.run_breakdancer_in.$group.$sam.$run_num -hold_jid $type.$version.igv_bam.$group.$run_num -t $nump-$nump:$nump -l h_vmem=$mem"
						qsub $args $qsub_args $script_path/run_breakdancer.sh $sam $igv $break/$group $run_info $group
			...
			then
				...
				do
					...
					$script_path/check_qstat.sh $limit
					mem=$( cat $memory_info | grep -w '^annotation_CNV' | cut -d '=' -f2)
					qsub_args="-N $type.$version.annotation_CNV.$group.$run_num -hold_jid $id -l h_vmem=$mem"
					qsub $args $qsub_args $script_path/annotation_CNV.sh $sv $run_info $annot $group
					$script_path/check_qstat.sh $limit
					mem=$( cat $memory_info | grep -w '^annotation_SV' | cut -d '=' -f2)
					qsub_args="-N $type.$version.annotation_SV.$group.$run_num -hold_jid $id -l h_vmem=$mem"
			...
			do
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^sample_numbers' | cut -d '=' -f2)
				qsub_args="-N $type.$version.sample_numbers.$group.$run_num -hold_jid $id -l h_vmem=$mem"
				qsub $args $qsub_args $script_path/sample_numbers.sh $output_dir $group $run_info $numbers
				$script_path/check_qstat.sh $limit
				mem=$( cat $memory_info | grep -w '^gene_summary' | cut -d '=' -f2)
				qsub_args="-N $type.$version.gene_summary.$group.$run_num -hold_jid $id -l h_vmem=$mem"
			...
			then
				...
				for group in `echo $groups | tr ":" "\n"`
				do
					id=$id"$type.$version.getCoverage.$group.$run_num,$type.$version.sample_numbers.$group.$run_num,$type.$version.gene_summary.$group.$run_num,$type.$version.igv_bam.$group.$run_num,$type.$version.sample_report.$group.$run_num,$type.$version.annotation_CNV.$run_num,$type.$version.annotation_SV.$run_num,"
				done          
			...
			then
				...
				for group in `echo $groups | tr ":" "\n"`
				do
					id=$id"$type.$version.getCoverage.$group.$run_num,$type.$version.sample_numbers.$group.$run_num,$type.$version.gene_summary.$group.$run_num,$type.$version.igv_bam.$group.$run_num,$type.$version.sample_report.$group.$run_num,"
				done    
			fi
			$script_path/check_qstat.sh $limit
			mem=$( cat $memory_info | grep -w '^merge_sample' | cut -d '=' -f2)
			...
			$script_path/check_qstat.sh $limit
			mem=$( cat $memory_info | grep -w '^generate_html' | cut -d '=' -f2)
			qsub_args="-N $type.$version.generate_html.$run_num -hold_jid $type.$version.merge_sample.$run_num -l h_vmem=$mem"
			qsub $args $qsub_args $script_path/generate_html.sh $output_dir $run_info 	
		fi
	fi
	echo `date`
