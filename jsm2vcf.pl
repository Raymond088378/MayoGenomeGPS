...
while(my $row = <IN>){
	...
	print OUT "$chr\t$pos\t.\t$ref\t$alt\t.\tPASS\t" . "." . "\tGT:IGT:DP:DP4:BCOUNT:GQ:JGQ:VAQ:BQ:MQ:TMQ:SS:SSC:PGERM:PLOH:PHETMUT:PHOMMUT:PSOM:PPS:INSC:DELC:POW:IMPAIR:MQ0:MUTX_LOD:SOMATIC:AD\t" . "$ngeno[$id]:.:$normal_depth:.:.:99:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:.:$normal_depth_ref,$normal_depth_alt\t" . "$tgeno[$id]:.:$tumor_depth:.:.:99:.:.:.:.:.:.:.:$PGERM:$PLOH:$PHETMUT:$PHOMMUT:$PSOM:$line[$#line]:.:.:.:.:.:.:.:$tumor_depth_ref,$tumor_depth_alt\n";	    
}}
close IN;
close OUT;
sub header{
